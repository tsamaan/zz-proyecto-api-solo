...
function Login() {
  ...
  return (
    <div style={{ maxWidth: 400, margin: "4rem auto", background: "#fff", borderRadius: 18, boxShadow: "0 8px 32px #22223b99", padding: 32, border: "2px solid #e11d48" }}>
      <h1 style={{ color: "#e11d48", fontSize: 28, fontWeight: 700, marginBottom: 24, textAlign: "center" }}>Iniciar sesión</h1>
      <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 18 }}>
        ...
        <button type="submit" disabled={loading} style={{ background: "#e11d48", color: "#fff", border: "none", borderRadius: 8, padding: "12px 0", fontWeight: 700, fontSize: 18, marginTop: 12, boxShadow: "0 2px 8px #e5e7eb" }}>Ingresar</button>
      </form>
    </div>
  );
}
